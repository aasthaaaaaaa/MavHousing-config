...
export function bulletinPosted(ctx: TemplateContext) {
  return {
    ...
    html: baseLayout(`
      ...
      <hr class="divider" />
      <p>You are receiving this because the post is relevant to your housing assignment. Contact Housing Operations at <a href="mailto:blaze@mavhousing.xyz">blaze@mavhousing.xyz</a> for questions.</p>
    `),
  };
}
