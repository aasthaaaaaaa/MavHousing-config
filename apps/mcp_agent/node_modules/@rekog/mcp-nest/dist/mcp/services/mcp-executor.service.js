...
let McpExecutorService = McpExecutorService_1 = class McpExecutorService {
    constructor(moduleRef, registry, mcpModuleId, options, authService, reflector) {
        this.logger = (0, mcp_logger_factory_1.createMcpLogger)(McpExecutorService_1.name, options);
        this.toolsHandler = new mcp_tools_handler_1.McpToolsHandler(moduleRef, registry, reflector, mcpModuleId, options, authService);
        this.resourcesHandler = new mcp_resources_handler_1.McpResourcesHandler(moduleRef, registry, reflector, mcpModuleId);
        this.promptsHandler = new mcp_prompts_handler_1.McpPromptsHandler(moduleRef, registry, reflector, mcpModuleId);
    }
...
exports.McpExecutorService = McpExecutorService = McpExecutorService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [core_1.ModuleRef,
        mcp_registry_discovery_service_1.McpRegistryDiscoveryService, String, Object, tool_authorization_service_1.ToolAuthorizationService,
        core_1.Reflector])
], McpExecutorService);
