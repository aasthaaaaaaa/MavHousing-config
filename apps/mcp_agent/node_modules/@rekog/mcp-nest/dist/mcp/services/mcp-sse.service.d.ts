...
export declare class McpSseService {
    ...
    constructor(options: McpOptions, mcpModuleId: string, applicationConfig: ApplicationConfig, moduleRef: ModuleRef, toolRegistry: McpRegistryDiscoveryService, pingService: SsePingService);
    initialize(): void;
